define([
  ...
  return declare([TabViewerBase], {
    ...
    postCreate: function () {
      ...
      // Fetch geomap data
      xhr.get(PathJoin(this.apiServiceUrl, 'genome') + '/?eq(taxon_id,10244)&in(collection_year,("2024","2025","2026"))&in(genome_status,("Complete","Partial"))&select(genome_name,clade,isolation_country,state_province)&limit(100000)', {
        headers: {
